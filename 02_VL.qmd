...
2. *Nutzerdaten*:
    * Tabelle "user_events"
    * Enthält Zeitstempel und event_type, entweder "subscribe" oder "unsubscribe"
...
* Warum stagniert das Wachstum bei Tofispy? 
* Wächst Tofispy schneller oder langsamer als der Gesamtmarkt? 
* Sind die Datensätze eher dispositiv oder operativ?
...
{{< video https://vimeo.com/770676371 width="80%" height="80%" >}}
