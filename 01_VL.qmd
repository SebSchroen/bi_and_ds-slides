...
## Apache Superset {visibility="hidden"}
### Stresstest
...
* Die Superset Instanz bleibt bis zur letzten Vorlesung online.
...
* 3 gefundene und gemeldete Typos (E-Mail, StudIP)  = 1 PickUp
...
* Methodische Aspekte rund um Predictive Analytics entstammen größtenteils [Introduction to Statistical Learning, 2. Auflage](https://www.statlearning.com/) von Gareth James, Daniela Witten, Trevor Hastie und Robert Tibshirani
