...
* Nun sind 2 Schritte notwendig:
  1. Auswahl des Datasets
      * Hier wählen wir "Warmup" aus
  2. Auswahl des Chart-Typs
      * Ein guter Startpunkt für die explorative Analyse ist eine Tabelle, also wählen wir Table

## Warmup
### Datenexploration in Superset

![](img/Superset_Explorer-1.jpg){width="800" height="500"}

## Warmup
### Datenexploration in Superset

![](img/Superset_Explorer-2.jpg){width="800" height="500"}
...
![](img/Superset_Explore.png){width="800" height="500"}
