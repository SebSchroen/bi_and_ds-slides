...
* Am Beispiel des Spam-Filters haben wir gesehen, dass Accuracy bei unbalancierten Datensätzen nicht ausreicht
...
![Precision und Recall in Abhängigkeit von $C$. Quelle: @shen_actively_2009 ](img/Relationship-of-thresholds-and-matching-performance-precision-recall-and-f1-Measure){width=80%}
...
* Fragen:
  * Wie hoch ist Precision für Klassik?
