...
$$
d(p,q) = \sqrt{(0.1-0.5)^2 + (0.3-0.9)^2} = 0.7211
$$
...
#  mutate(Wahrscheinlichkeit = "", Vorhersage = "") %>% 
  kable(digits = 2)
...
* Die Grafik rechts zeigt ein extremes Beispiel mit 5 Nodes
...
## Organisatorisches
### Ausblick auf die letze Vorlesung

* Inhalte:
  * Assoziationsanalyse
  * Grundregeln der Visualisierung
* Gruppenarbeit an der Probeklausur (30 Minuten)
* Evaluation und offenes Feedback (15 Minuten)
* Besprechung der Probeklausur (45-60 Minuten)
* Fragen zur Vorlesung
* Probeklausur wird vorab hochgeladen
* Fragen für die letzte Vorlesung bis zum 28. April per Mail